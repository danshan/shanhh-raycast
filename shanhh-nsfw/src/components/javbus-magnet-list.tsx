...
import { useJavbusMagnets } from "../hooks/use-javbus-search";
import { JavbusDetailData, JavbusMagnet } from "../types/javbus-search";

export function JavbusMagnetList(props: { detail?: JavbusDetailData }) {
  const { magnets, isLoading } = useJavbusMagnets(props?.detail?.magnetSearchUrl || "", props?.detail?.url || "");
