...
- [technical-design.md](./technical-design.md): 技术方案, 安全边界, correctness baseline 和演进约束.
- [development.md](./development.md): 本地配置, 开发, 验证和发布流程.
- [code-review-2026-09-16.md](./code-review-2026-09-16.md): 本轮完整 review 的基线证据, 整改状态和残余风险.
